...
public interface HelpDocument {}
			...
			//HTML5
			//Legacy HTML5
			//All of these modes refer to well-formed XML files except the Legacy HTML5 mode, which allows you to process HTML5 files 
            //with features such as standalone (not closed) tags, tag attributes without a value or not written between quotes. In order to process files in this specific mode, Thymeleaf will first perform a transformation that will convert your files to well-formed XML files which are still perfectly valid HTML5